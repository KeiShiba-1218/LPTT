...
def create_lmdb():
    ...
    folder_path = 'datasets/FiveK/FiveK_original/test/A'
    lmdb_path = 'datasets/FiveK/FiveK_original_test_source.lmdb'
    img_path_list, keys = prepare_keys(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = 'datasets/FiveK/FiveK_original/test/B'
    lmdb_path = 'datasets/FiveK/FiveK_original_test_target.lmdb'
    img_path_list, keys = prepare_keys(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)
