...
# PYTHONPATH="./:${PYTHONPATH}" CUDA_VISIBLE_DEVICES=3 python codes/test_speed.py -opt options/test/LPTN/test_speed_FiveK.yml
...
# PYTHONPATH="./:${PYTHONPATH}" CUDA_VISIBLE_DEVICES=3 python codes/train.py -opt options/train/LPTT/train_FiveK.yml
...
# PYTHONPATH="./:${PYTHONPATH}" CUDA_VISIBLE_DEVICES=3,2 python -m torch.distributed.launch --nproc_per_node=2 --master_port=1234 codes/train.py -opt options/train/LPTT/train_FiveK.yml --launcher pytorch
