...
# PYTHONPATH="./:${PYTHONPATH}" CUDA_VISIBLE_DEVICES=1,2 python -m torch.distributed.launch --nproc_per_node=2 --master_port=4321 codes/train.py -opt options/train/train_FiveK_05.yml --launcher pytorch
...
# PYTHONPATH="./:${PYTHONPATH}" CUDA_VISIBLE_DEVICES=2 python codes/test.py -opt options/test/LPTT/test_FiveK.yml
